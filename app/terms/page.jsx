  ...
  return (
    <section className="text-black w-[80%] mx-auto px-[20px] py-[32px] mt-[120px] mb-[100px]">
      ...
      <div className="space-y-[22px]">
        ...
        <section>
          <h2 className="font-catamaran text-[25px] mb-[8px]">3. Services</h2>
        ...
        <section>
          <h2 className="font-catamaran text-[25px] mb-[8px]">6. Liability</h2>
          <p className="font-raleway text-[17px]">
        ...
        <section>
          <h2 className="font-catamaran text-[25px] mb-[8px]">10. Contact</h2>
