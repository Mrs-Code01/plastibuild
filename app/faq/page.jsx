...
export default function page() {
  return (
    <main className="text-[#000000] mt-[150px]">
      {/* Hero */}
      <section className="mx-auto w-[65%] px-6 py-12 text-center">
        <h1 className="font-catamaran text-[#262626] text-[35px] leading-[1.2]">
          PlastiBuild FAQs
        </h1>
      ...
      {/* FAQ Sections */}
      <section className="mx-auto w-[75%] px-6 pb-16">
          ...
          {faqs.map(faq => (
            ...
            >
              <header className="px-6 pt-6">
                <h2 className="font-catamaran text-[#262626] text-[21px]">
                  {faq.title}
                </h2>
              </header>
              ...
              <div className="px-6 pb-6">
                <ul className="mt-4 space-y-4">
                  {faq.items.map(item => (
                    ...
                    >
                      <p className="font-raleway font-[800] text-[17px] mb-[10px]">
                        {item.q}
                      </p>
                      <p className="font-raleway text-[17px]">{item.a}</p>
                    </li>
                  ))}
                </ul>
              </div>
